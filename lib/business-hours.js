...
/*
adaptation of lennym's moment business time for sketchdeck use.
https://github.com/mentheosis/moment-business-time/tree/sketchdeck
*/
  ...
  //hack work-around for older moment version
  if(!moment.locale) {
    moment.locale = moment.lang;
    moment.localeData = moment.langData;
  }
  ...
  moment.fn.isHoliday = function isHoliday() {
      ...
      getLocaleData('holidays').forEach(function (holiday) {
          if (today.isSame(moment(holiday),'day')) {
              isHoliday = true;
          }
      });
      return isHoliday;
